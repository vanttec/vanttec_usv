...
def main():
    ...
    while not rospy.is_shutdown():    
        ...
        if (usvMaster.xbee_message == 'CA') or (usvMaster.xbee_message == 'ca'):
            ...
            while ((usvMaster.mission_status != 1) and  
                  (usvMaster.kill_switch != True) and (not rospy.is_shutdown())):
            ...
            usvMaster.xbee_message= ''
            while ((usvMaster.mission_status != 1) and (usvMaster.kill_switch!=True)  
