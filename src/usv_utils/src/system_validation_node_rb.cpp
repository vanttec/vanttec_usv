    ...
    public:
        SystemStatusNode(): Node("system_validation_node") {
            ...
            lidar_sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
                "velodyne_points", 10,
                [this](const sensor_msgs::msg::PointCloud2 &){
            ...
            obj_list_sub_ = this->create_subscription<usv_interfaces::msg::ObjectList>(
    ...
    private:
        ...
        void timer_callback() {
            ...
            auto elapsed_ms = [this](rclcpp::Time t) {
                return (this->now() - t).nanoseconds() / 1000000;
            };

            out.can_stm_status    = elapsed_ms(last_recev)         <= 500;
            out.lidar_status      = elapsed_ms(last_lidar_recev)   <= 500;
            out.camera_status     = elapsed_ms(last_camera_recev)  <= 500;
