...
public:
    PathPublisher_node() : Node("path_publisher_node")
    {
        ...
        timer_ = this->create_wall_timer(10ms, std::bind(&PathPublisher_node::update, this));
    }
...
void update()
{
    ...
    double amplitude = 3.0;    // Amplitude of the sine wave
    double frequency = 0.5;    // Frequency of the sine wave
    int num_waypoints = 500;   // Number of waypoints to generate
